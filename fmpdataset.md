...
Include your API key in the request header as: apikey: wwptjIDRkb1EI5cXgBiJ0QZ8uphcde88

URL Query Authorization

To authorize your requests, append ?apikey=wwptjIDRkb1EI5cXgBiJ0QZ8uphcde88 at the end of every request.
...
Nasdaq data is delayed by 15 minutes. Real-time access requires completion of the user declaration form.
...
In partnership with
TipRanks logo — analyst ratings, price targets and recommendation data available on Financial Modeling Prep
Analyst ratings, price targets & recommendation data
TipRanks
These endpoints require an active TipRanks add-on. Add it to your plan to start making requests.

Analyst Ratings Search API
...
Ratings history only goes back 3 years. For analyst ratings older than 3 years, contact support — historical backfill requires an Enterprise plan.
...
Point in time Ratings by Symbol API
...
https://financialmodelingprep.com/stable/tipranks-pit-symbol?symbol=AAPL

Ratings history only goes back 3 years. For historical analyst ratings beyond that window, contact support — it requires an Enterprise plan.
...
[
	{
		"symbol": "AAPL",
		"date": "2026-05-14T22:19:39.563Z",
		"expertUID": "86f0b8c5491fa7bd1ba680992b5783ae1290473c",
		"analystName": "Ivan Feinseth",
		"firmName": "Tigress Financial",
		"recommendation": "Buy",
		"latestRecommendationDate": "2026-05-14",
		"analystRank": 685,
		"stockSuccessRate": 0.875,
		"stockAvgReturn": 16.4,
		"articleTitle": "Apple price target raised to $375 from $305 at Tigress Financial",
		"articleSite": "TipRanks Contributor",
		"articleQuote": "Apple price target raised to $375 from $305 at Tigress Financial",
		"priceTarget": 375,
		"priceTargetCurrency": 1,
		"priceTargetCurrencyCode": "USD",
		"url": "https://www.tipranks.com/news/the-fly/apple-price-target-raised-to-375-from-305-at-tigress-financial-thefly-news",
		"analystAction": "reiterated"
	}
]

Point in time Ratings by Analyst API
...
[
	{
		...
		"analystRank": 6961,
		"stockSuccessRate": 0.833,
		"stockAvgReturn": 41.9,
		"articleTitle": "Wall Street Analysts Are Bullish on Top Consumer Cyclical Picks",
		"articleSite": "TipRanks Contributor",
		"articleQuote": "",
		"priceTarget": 7,
		"priceTargetCurrency": 1,
		"priceTargetCurrencyCode": "USD",
		"urlSlug": "wall-street-analysts-are-bullish-on-top-consumer-cyclical-picks-blurbs-news-39",
		"url": "https://www.tipranks.com/news/blurbs/wall-street-analysts-are-bullish-on-top-consumer-cyclical-picks-blurbs-news-39",
		"analystAction": "reiterated"
	}
]

Ratings Summary by Symbol API
...
https://financialmodelingprep.com/stable/tipranks-symbol-summary?symbol=AAPL
...
Ratings Summary by Analyst API
...
https://financialmodelingprep.com/stable/tipranks-analyst-summary?expertUID=3c6eb8cf1347a4e5757e628fccb684a93abee587
...
[
	{
		"expertUID": "CB0E11B33EB5BFFB23C2BE3C3E47A56F",
		"from": "2025-05-21",
		"to": "2026-05-22",
...
https://financialmodelingprep.com/stable/tipranks-firm-summary?firmName=Morgan Stanley
...
Profile images and links require an API key to access.
...
[
	{
		"expertUID": "2fb9895a5fcf3a9475f0055ab900462277236bc5",
		"analystName": "Andrew Marok",
		"firmName": "Raymond James",
		"expertPictureURL": "685108_2DA407D7A6_tsqr.jpg",
		"successRate": 0.431,
		"excessReturn": 0.2,
		"totalRecommendations": 144,
		"goodRecommendations": 62,
		"numOfStars": 1.9,
		"stockSuccessRate": 0
	}
]
